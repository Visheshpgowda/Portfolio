...
const Education = () => {
  const data = [
    {
      ...
      content: (
        <div>
          ...
          <p className="text-neutral-600 dark:text-neutral-300 text-xs md:text-sm font-normal mb-8">
      ...
      content: (
        <div>
          ...
          <p className="text-neutral-600 dark:text-neutral-300 text-xs md:text-sm font-normal mb-8">
            ...
            <br></br>
            Achived Rajya Purskar in Scout-and-Guides
          </p>
        </div>
      ),
    },
  ...
  return (
   <section id="education">
     <div className="w-full px-4 md:px-8 lg:px-10 py-20 bg-white dark:bg-neutral-950">
